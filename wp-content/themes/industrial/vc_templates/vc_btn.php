 ...
 */
$style = $anps_btn_styles = $anps_btn_shadow = $shape = $color = $size = $custom_background = $custom_text = $align = $link = $title = $button_block = $el_class = $outline_custom_color = $outline_custom_hover_background =
...
if ( 'custom' === $style ) {
	...
	$button_classes = "";
	$button_classes[] = "btn";
	$button_classes[] = $anps_style;
	if ($add_shadow == true) {
		$button_classes[] = 'btn-shadow';
	}
} else {
