...
<form action="themes.php?page=theme_options&sub_page=footer&save_options" method="post">
    <div class="content-inner">
       ...
       <div class="row">
            ...
            <div class="col-md-4">
                <?php $anps_style->anps_create_checkbox('anps_enable_footer', 'Enable footer', '1');?>
            </div>
            <!-- Footer style -->        
            <div class="col-md-4">            
                <label for="anps_footer_style"><?php esc_html_e("Footer style", 'industrial'); ?></label>            
            ...
            <!-- Copyright footer -->
            <div class="col-md-4">            
                <label for="anps_copyright_footer"><?php esc_html_e("Copyright footer", 'industrial'); ?></label>            
            ...
            <div class="col-md-12">
                <?php $layout = array("classic"=>"Classic" ,"fixed-footer"=>"Fixed");
            ...
            <div class="col-md-12">
                <?php $layout = array("1"=>"1 column" ,"2"=>"2 columns");
