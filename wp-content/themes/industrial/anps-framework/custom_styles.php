...
function anps_custom_styles_colors() {
    ...
    */
	...
	@media(min-width: 1200px) {
        ...
        .site-header.full-width .mini-cart .mini-cart-link,
        .site-header.full-width .mini-cart-link {
            color: #<?php echo esc_attr($anps_primary_color); ?> !important;
        }
    ...
    @media(min-width: 1200px) {
		...
		header.site-header nav.site-navigation .main-menu ul li a:hover, header.site-header nav.site-navigation .main-menu ul li a:focus	{
