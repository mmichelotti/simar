...
class AnpsRecentNews extends WP_Widget {
    ...
    function __construct() {        
        $widget_ops = array('classname' => 'anps-recent-posts', 'description' => 'Shows recent news');
        parent::__construct('AnpsRecentNews', 'AnpsThemes - Recent News', $widget_ops);
    }
...
add_action('widgets_init', create_function('', 'return register_widget("AnpsRecentNews");'));