...
function anps_team_content_add_custom_box() {
    ...
    foreach ($screens as $screen) {
        add_meta_box('anps_team_social_meta', esc_html__('Social accounts', 'industrial'), 'anps_team_social_meta_box_content', $screen, 'side', 'core');
    }
    foreach ($screens as $screen) {
        add_meta_box(
                'anps_breadcrumbs_sectionid', esc_html__('Team subtitle', 'industrial'), 'anps_display_team_meta_box_content', $screen
        );
    }
}
