...
<form class="woocommerce-shipping-calculator" action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" method="post">
	...
	<section class="shipping-calculator-form" style="display:none;">
		...
		<p class="form-row form-row-wide select-wrapper" id="calc_shipping_country_field">
		...
		<p><button type="submit" name="calc_shipping" value="1" class="btn btn-md btn-minimal"><?php esc_html_e( 'Update Totals', 'woocommerce' ); ?></button></p>
