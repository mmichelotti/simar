...
<form method="post" class="lost_reset_password clearfix">
	...
	<p class="form-row">
		...
		<input type="submit" class="btn btn-md" value="<?php echo 'lost_password' === $args['form'] ? esc_html__( 'Reset Password', 'woocommerce' ) : esc_html__( 'Save', 'woocommerce' ); ?>" />
	</p>
