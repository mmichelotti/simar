...
<?php foreach ( $get_addresses as $name => $title ) : ?>
	...
	<div class="col-<?php echo ( ( $col = $col * -1 ) < 0 ) ? 1 : 2; ?> address">
		...
		<a href="<?php echo wc_get_endpoint_url( 'edit-address', $name ); ?>" class="edit btn btn-sm"><?php esc_html_e( 'Edit', 'woocommerce' ); ?></a>
		<address>
			<?php
				...
				if ( ! $formatted_address )
					...
					echo wp_kses($formatted_address, array('br' => array()));
			?>
		</address>
	</div>
