...
<?php $anps_bootstrap_class = ''; ?>
<?php if ( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' ) : ?>
	<?php $anps_bootstrap_class = 'col-md-6';?>
<div class="row" id="customer_login">

	<div class="<?php echo esc_attr($anps_bootstrap_class);?>">
...
<?php endif; ?>
		...
		<form method="post" class="login">
			...
			<p class="form-row">
				...
				<input type="submit" class="btn btn-md" name="login" value="<?php esc_attr_e( 'Login', 'woocommerce' ); ?>" />
	...
	<div class="<?php echo esc_attr($anps_bootstrap_class);?>">
		...
		<form method="post" class="register">
			...
			<p class="form-row">
				...
				<input type="submit" class="btn btn-md" name="register" value="<?php esc_attr_e( 'Register', 'woocommerce' ); ?>" />
			</p>
